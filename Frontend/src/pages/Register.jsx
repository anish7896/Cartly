...
function Register() {
    ...
    return (
        ...
        <div className="h-screen w-full overflow-hidden bg-gradient-to-br from-[#0F1115] via-[#14171D] to-[#1B2028] text-[#F5F7FA]">
            ...
            <header className="absolute top-0 left-0 z-30 w-full h-[72px] px-6 md:px-10 flex items-center justify-between">
                ...
                <button
                    onClick={() => navigate("/")}
                    className="text-sm text-[#9AA4B2] hover:text-[#2DB6C0] transition-colors"
                >
                    Back to home
                </button>
            ...
            <main className="h-[calc(100vh-72px)] w-full flex items-center justify-center pt-[72px] px-5">
                ...
                <div className="w-full max-w-[560px] h-[500px] bg-[#171A21]/95 border border-[#2A303A] rounded-xl shadow-2xl flex items-center justify-center backdrop-blur-xl">
                    ...
                    >
                        ...
                        <div className="w-full text-center mb-5">
                            ...
                            <p className="text-[#9AA4B2] text-sm mt-2">
                                Register to access exclusive offers, faster checkout,
                                and order tracking.
                            </p>
                        ...
                        <p className="text-[#9AA4B2] text-sm mt-4">
